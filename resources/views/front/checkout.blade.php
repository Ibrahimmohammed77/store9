                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    ...
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[billing][street_addres]" placeholder="Mailing Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form button">
                                                    <a class="btn"  data-bs-toggle="collapse" href="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
                                                        next step</a>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="single-form form-default">
                                                    <label>Mailing Address</label>
                                                    <div class="form-input form">
                                                        <x-form.input name="addr[shipping][street_addres]" placeholder="Mailing Address" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-12">
                                                <div class="steps-form-btn button">
                                                    <a class="btn" data-bs-toggle="collapse" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree">previous</button>
                        ...
                        <div class="checkout-sidebar-price-table mt-30">
                            ...
                            <div class="sub-total-price">
                                <div class="total-price">
                                    ...
                                    <p class="price">{{ Curency::format($cart->total()) }}</p>
                                </div>

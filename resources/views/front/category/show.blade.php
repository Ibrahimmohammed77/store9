                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                ...
                                @foreach ($categories as $category)
                                    <li>
                                        <a href="{{ route('front.category.show', $category->id) }}">{{ $category->name }}</a>
                                    </li>
                                @endforeach
                            </ul>
                        </div>
                                            ...
                                            <div class="single-product">
                                                <div class="product-image">
                                                    ...
                                                    @if ($product->sale_percent_price)
                                                        <span
                                                            class="sale-tag">-{{ $product->sale_percent_price }}%</span>
                                                    @endif
                                                    <div class="button">
                                                ...
                                                <div class="product-info">
                                                    ...
                                                    <div class="price">
                                                        ...
                                                        <span
                                                            class="discount-price">{{ Curency::format($product->compare_price) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <!-- End Single Product -->
